...
import type { PasswordCategoryDto } from '~/types/api'
...
async function startGame() {
  ...
  loading.value = true
  try {
    const result = await createPasswordGameSession(teamNames.value, selectedCategoryIds.value, roundsPerTeam.value)
